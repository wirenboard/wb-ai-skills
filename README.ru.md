...
Каталог `wb-plc/skills/` содержит девять скиллов, покрывающих всё, что нужно удалённому агенту для управления контроллером WB: обнаружение, диагностику, сеть, MQTT, Modbus, правила автоматизации, Zigbee, резервное копирование/восстановление и написание собственного ПО для контроллера.
